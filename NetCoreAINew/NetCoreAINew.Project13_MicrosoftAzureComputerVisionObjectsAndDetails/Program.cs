...
class Program
{
    ...
    private static readonly string requestParameters = "visualFeatures=Categories,Description,Tags,Color,Faces,Objects,Brands,Adult,ImageType&language=en&model-version=latest";
    ...
    static async Task Main(string[] args)
    {
        ...
        using (ByteArrayContent content = new ByteArrayContent(imageBytes))
        {
            ...
            if (response.IsSuccessStatusCode)
            {
                ...
                {
                    string name = obj.GetProperty("object").ToString();
